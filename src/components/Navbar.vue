<template>
  <nav>
    ...
    <v-toolbar flat app color="teal lighten-1">
    ...
    <v-navigation-drawer app class="blue-grey darken-3" v-model="drawer">
      <v-layout column align-center class="pt-4">
        <v-flex class="mt-5">
          <v-avatar size="100">
            <img src="/avatar-1.png">
          </v-avatar>
          <p class="white--text subheading mt-1" align-center>Jon Snow....</p>
        </v-flex>
